            ...
            <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                <div class="card border border-success card-hover" style="width: 100%;">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('productos.comprar', ['id' => $producto->producto_id])); ?>" method="POST" style="display: inline;">
                            <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\xampp1\htdocs\portales\final\resources\views/productos/index.blade.php ENDPATH**/ ?>