...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Editar Perfil <?php $__env->endSlot(); ?>
            ...
            <div class="card-body">
                ...
                <form action="<?php echo e(route('perfil.update')); ?>" method="POST">
                    ...
                    <div class="d-flex">
                        ...
                        <a href="<?php echo e(route('perfil.show')); ?>" class="btn btn-secondary">Cancelar</a>
                    </div>
                </form>
            </div>
        </div>
...
<?php endif; ?><?php /**PATH C:\xampp1\htdocs\portales\parcial_01\resources\views/perfil/edit.blade.php ENDPATH**/ ?>